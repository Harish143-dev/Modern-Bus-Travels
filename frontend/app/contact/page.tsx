...
const Contact = () => {
  return (
    <main className="bg-background text-foreground pt-16 px-10 min-h-screen">
      ...
      <section className="flex flex-col md:flex-row lg:flex-row justify-center items-center gap-10 py-10">
